...
def item003(request):
    if not request.user.is_authenticated:
        context = {'page_title':'item003','item_list': {}}
        return render(request, 'app001/item003.html', context)     
        
    item_list = Item003.objects.order_by('field1')[:100]
    context = {'page_title':'item003','item_list': item_list}
    return render(request, 'app001/item003.html', context)     
